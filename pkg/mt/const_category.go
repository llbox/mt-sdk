...
// CategoryName 返回分类的中文名称
var CategoryName = map[Category]string{
	CategoryMovie:               "电影",
	CategoryTVSeries:            "影剧/综艺",
	CategoryMusic:               "Music",
	CategoryAVCensored:          "AV(有码)",
	CategoryAVUncensored:        "AV(无码)",
	CategoryMovieSD:             "电影/SD",
	CategoryTVSeriesHD:          "影剧/综艺/HD",
	CategoryTVSeriesSD:          "影剧/综艺/SD",
	CategoryRecord:              "纪录",
	CategoryAnime:               "动画",
	CategoryMV:                  "演唱",
	CategorySports:              "运动",
	CategoryMiscOther:           "其他",
	CategoryAVHDCensored:        "AV(有码)/HD Censored",
	CategoryHGame:               "H-游戏",
	CategoryHAnime:              "H-动漫",
	CategoryHComic:              "H-漫画",
	CategoryMovieHD:             "电影/HD",
	CategoryMovieDVDiSo:         "电影/DVDiSo",
	CategoryMovieBluRay:         "电影/BluRay",
	CategorySoftware:            "软件",
	CategoryPCGame:              "PC游戏",
	CategoryAVSDCensored:        "AV(有码)/SD Censored",
	CategoryIVVideoCollection:   "IV(写真影集)",
	CategoryAVDVDiSoUncensored:  "AV(无码)/DVDiSo Uncensored",
	CategoryEBook:               "电子书",
	CategoryAVHDUncensored:      "AV(无码)/HD Uncensored",
	CategoryAVSDUncensored:      "AV(无码)/SD Uncensored",
	CategoryAVBluRayCensored:    "AV(有码)/Blu-Ray Censored",
	CategoryAVBluRayUncensored:  "AV(无码)/Blu-Ray Uncensored",
	CategoryIVPictureCollection: "IV(写真图集)",
	CategoryMusicLossless:       "Music(无损)",
	CategoryTVSeriesDVDiSo:      "影剧/综艺/DVDiSo",
	CategoryAV0Day:              "AV(网站)/0Day",
	CategoryAVDVDiSoCensored:    "AV(有码)/DVDiSo Censored",
	CategoryTVSeriesBluRay:      "影剧/综艺/BluRay",
	CategoryMovieRemux:          "电影/Remux",
	CategoryAVGayHD:             "AV(Gay)/HD",
	CategoryAudioBook:           "有声书",
	CategoryDocumentary:         "纪录",
	CategoryIV:                  "IV",
	CategoryHACG:                "H-ACG",
	CategoryGame:                "游戏",
	CategoryTvGame:              "TV游戏",
	CategoryAnimeRoot:           "动漫",
	CategoryMisc:                "其他",
	CategoryEducation:           "教育影片",
	CategoryAnimeBluRay:         "动画/BluRay",
}
