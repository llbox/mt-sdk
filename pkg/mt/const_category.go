...
// CategoryName 返回分类的中文/英文名称
var CategoryName = map[Category]string{
	CategoryMovie:               "电影 Movie",
	CategoryTVSeries:            "影剧/综艺 TV Series",
	CategoryMusic:               "Music",
	CategoryAVCensored:          "AV(有码) AV(有碼)",
	CategoryAVUncensored:        "AV(无码) AV(無碼)",
	CategoryMovieSD:             "电影/SD Movie/SD",
	CategoryTVSeriesHD:          "影剧/综艺/HD TV Series/HD",
	CategoryTVSeriesSD:          "影剧/综艺/SD TV Series/SD",
	CategoryRecord:              "纪录 Record",
	CategoryAnime:               "动画 Anime",
	CategoryMV:                  "演唱 MV",
	CategorySports:              "运动 Sports",
	CategoryMiscOther:           "Misc(其他) Misc(Other)",
	CategoryAVHDCensored:        "AV(有码)/HD Censored AV(有碼)/HD Censored",
	CategoryHGame:               "H-游戏 H-Game",
	CategoryHAnime:              "H-动漫 H-Anime",
	CategoryHComic:              "H-漫画 H-Comic",
	CategoryMovieHD:             "电影/HD Movie/HD",
	CategoryMovieDVDiSo:         "电影/DVDiSo Movie/DVDiSo",
	CategoryMovieBluRay:         "电影/BluRay Movie/BluRay",
	CategorySoftware:            "软件 Software",
	CategoryPCGame:              "PC游戏 PCGame",
	CategoryAVSDCensored:        "AV(有码)/SD Censored AV(有碼)/SD Censored",
	CategoryIVVideoCollection:   "IV(写真影集) IV/Video Collection",
	CategoryAVDVDiSoUncensored:  "AV(无码)/DVDiSo Uncensored AV(無碼)/DVDiSo Uncensored",
	CategoryEBook:               "電子書 E-Book",
	CategoryAVHDUncensored:      "AV(无码)/HD Uncensored AV(無碼)/HD Uncensored",
	CategoryAVSDUncensored:      "AV(无码)/SD Uncensored AV(無碼)/SD Uncensored",
	CategoryAVBluRayCensored:    "AV(有码)/Blu-Ray Censored AV(有碼)/Blu-Ray Censored",
	CategoryAVBluRayUncensored:  "AV(无码)/Blu-Ray Uncensored AV(無碼)/Blu-Ray Uncensored",
	CategoryIVPictureCollection: "IV(写真图集) IV/Picture Collection",
	CategoryMusicLossless:       "Music(无损) Music(Lossless)",
	CategoryTVSeriesDVDiSo:      "影剧/综艺/DVDiSo TV Series/DVDiSo",
	CategoryAV0Day:              "AV(网站)/0Day AV(網站)/0Day",
	CategoryAVDVDiSoCensored:    "AV(有码)/DVDiSo Censored AV(有碼)/DVDiSo Censored",
	CategoryTVSeriesBluRay:      "影剧/综艺/BluRay TV Series/BluRay",
	CategoryMovieRemux:          "电影/Remux Movie/Remux",
	CategoryAVGayHD:             "AV(Gay)/HD",
	CategoryAudioBook:           "有聲書 AuiBook",
	CategoryDocumentary:         "紀錄 BBC",
	CategoryIV:                  "IV",
	CategoryHACG:                "H-ACG",
	CategoryGame:                "遊戲",
	CategoryTvGame:              "TV遊戲 TvGame",
	CategoryAnimeRoot:           "動漫 Anime",
	CategoryMisc:                "其他",
	CategoryEducation:           "教育影片",
	CategoryAnimeBluRay:         "动画/BluRay Anime/BluRay",
}
